...
from trend_scan.collectors import hackernews  # noqa: E402
...
def main() -> None:
    ...
    payload = hackernews.collect(context, settings)
    write_json(raw_path(context.run_date_str, "hackernews"), payload)
