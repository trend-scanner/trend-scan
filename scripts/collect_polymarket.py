...
from trend_scan.collectors import polymarket  # noqa: E402
...
def main() -> None:
    ...
    payload = polymarket.collect(context, settings)
    write_json(raw_path(context.run_date_str, "polymarket"), payload)
