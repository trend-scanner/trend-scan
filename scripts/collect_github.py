...
from trend_scan.collectors import github_api  # noqa: E402
...
def main() -> None:
    ...
    payload = github_api.collect(context, settings)
    write_json(raw_path(context.run_date_str, "github"), payload)
